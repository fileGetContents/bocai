...
class MY_Controller extends CI_Controller
{
    ...
    // 获取网站的seo配置
    public function getSeoWeb()
    {
        $seo = $this->db->get("bocweb");
        return $seo->result_array();
    }

    /**
     * 获取优化内容
     * @param $where   array  id
     * @param $table string  表名
     */
    public function getSeo($where = array(), $table)
    {
        $seo = $this->db->where($where)->get($table);
        $return = $seo->result_array();
        return $return;
    }
