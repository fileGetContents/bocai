	...
	$.fn.lightBox = function(settings) {
		...
		function _set_image_to_view() { // show the loading
			...
			objImagePreloader.onload = function() {
				...
				var _n=objImagePreloader.height/objImagePreloader.width;
				if(objImagePreloader.width>$(window).width()){
					objImagePreloader.width=$(window).width()-40;
					objImagePreloader.height=objImagePreloader.width*_n;
				}
		...
		function _set_navigation() {
			...
			if ( settings.activeImage != ( settings.imageArray.length -14 ) ) {
				console.log(0);
				console.log(settings.activeImage);
				console.log(settings.imageArray.length);
				if ( settings.fixedNavigation ) {
