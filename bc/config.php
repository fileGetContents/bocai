...
define('DB_USER'   , 'root');
define('DB_PASS'   , '');
define('DB_NAME'   , 'xjw_bocweb');
define('DB_PREFIX' , 'boc_');

# 全局URL路径
// 主域名 保留最后的 /
//define('GLOBAL_URL'  , 'http://'.$_SERVER['HTTP_HOST'].'/bocweb/web/');
//define('GLOBAL_URL_SQL'  , 'http://'.$_SERVER['HTTP_HOST'].'/bocweb/boc/');

define('GLOBAL_URL'  , 'http://localhost/bc/web/');
define('GLOBAL_URL_SQL'  , 'http://localhost/bc/boc/');
